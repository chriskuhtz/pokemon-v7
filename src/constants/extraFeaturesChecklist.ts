export const extraFeatureCheckList: {
  ...
  { name: "refactor ownedpokemoncardcontent, quite crowded", handled: true },
  { name: "Occupant: Random Item", handled: true },
  ...
  { name: "move chuck and move tutor out of battle pit", handled: true },
  { name: "random encounters", handled: true },
  { name: "random evolutions", handled: true },
  { name: "music" },
  { name: "eggs?" },
  { name: "Fishing?" },
  { name: "opponents can switch" },
  ...
  { name: "nuzlocke mode" },
  { name: "transfer labyrinth team to kuma after win" },
  { name: "Labyrinth level 3" },
  { name: "Labyrinth level 4" },
  { name: "Labyrinth level 5" },
  { name: "Labyrinth level 6" },
  { name: "Labyrinth level 7" },
