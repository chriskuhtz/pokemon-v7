...
export const routeN1W1Occupants: OverworldMap["occupants"] = [
  ...
  },
  {
    ...
    item: "old-amber",
    amount: 1,
    conditionFunction: (s) => !occupantHandled(s, "old-amber-routeN1W1"),
    id: "old-amber",
  },
  {
    type: "ITEM",
    ...
    item: "never-melt-ice",
    amount: 1,
    conditionFunction: (s) => !occupantHandled(s, "nevermeltice-routeN1W1"),
  ...
  },
  {
    ...
    item: "damp-rock",
    amount: 1,
    conditionFunction: (s) => !occupantHandled(s, "damp-rock-routeN1W1"),
