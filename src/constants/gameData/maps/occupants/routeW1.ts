...
export const routeW1Occupants: OverworldMap["occupants"] = [
  ...
  },
  {
    ...
    x: 49,
    y: 40,
    conditionFunction: (s) => !occupantHandled(s, "routeW1_sudowoodo"),
    id: "routeW1_sudowoodo",
    orientation: "UP",
  },
  {
    type: "ON_STEP_PORTAL",
  ...
  },
  {
    ...
    item: "escape-rope",
    amount: 5,
    conditionFunction: (s) => !occupantHandled(s, "routeW1-escape-ropes"),
  ...
  },
  {
    ...
    item: "fire-stone",
    amount: 1,
    conditionFunction: (s) => !occupantHandled(s, "routeW1-fire-stone"),
  ...
  },
  {
    ...
    item: "plume-fossil",
    amount: 1,
    conditionFunction: (s) => !occupantHandled(s, "routeW1-plume-fossil"),
  ...
  },
  {
    ...
    item: "rage-candy-bar",
    amount: 2,
    conditionFunction: (s) => !occupantHandled(s, "routeW1-rage-candy-bar"),
