...
export const routeS1Occupants: OverworldMap["occupants"] = [
  ...
  },
  {
    ...
    item: "soft-sand",
    amount: 1,
    conditionFunction: (s) => !occupantHandled(s, "lake_softsand"),
    id: "lake_softsand",
  },
  {
    type: "ITEM",
    ...
    item: "cover-fossil",
    amount: 1,
    conditionFunction: (s) => !occupantHandled(s, "lake-fossil"),
    id: "lake-fossil",
  },
  {
    type: "ITEM",
    ...
    item: "net-ball",
    amount: 10,
    conditionFunction: (s) => !occupantHandled(s, "lake-net-balls"),
    id: "lake-net-balls",
  },
  {
    type: "ITEM",
    ...
    item: "full-restore",
    amount: 1,
    conditionFunction: (s) => !occupantHandled(s, "lake-full-restore"),
  ...
  },
  {
    ...
    item: "kings-rock",
    amount: 1,
    conditionFunction: (s) => !occupantHandled(s, "kings-rock-s1"),
    id: "kings-rock-s1",
  },
  {
    type: "POKEMON",
