...
export const victoryRoadOccupants: OverworldMap["occupants"] = [
  ...
  },
  {
    ...
    x: 44,
    y: 14,
    conditionFunction: (s) => !occupantHandled(s, "ledge-victoryRoad-1"),
  ...
  },
  {
    ...
    x: 45,
    y: 14,
    conditionFunction: (s) => !occupantHandled(s, "ledge-victoryRoad-2"),
  ...
  },
  {
    ...
    x: 46,
    y: 14,
    conditionFunction: (s) => !occupantHandled(s, "ledge-victoryRoad-3"),
  ...
  },
  {
    ...
    x: 20,
    y: 39,
    conditionFunction: (s) => !occupantHandled(s, "rock_victory_road_1"),
  ...
  },
  {
    ...
    x: 32,
    y: 37,
    conditionFunction: (s) => !occupantHandled(s, "rock_victory_road_2"),
  ...
  },
  {
    ...
    x: 23,
    y: 44,
    conditionFunction: (s) => !occupantHandled(s, "rock_victory_road_3"),
  ...
  },
  {
    ...
    x: 21,
    y: 30,
    conditionFunction: (s) => !occupantHandled(s, "rock_victory_road_4"),
  ...
  },
  {
    ...
    x: 23,
    y: 22,
    conditionFunction: (s) => !occupantHandled(s, "rock_victory_road_5"),
  ...
  },
  {
    ...
    x: 41,
    y: 21,
    conditionFunction: (s) => !occupantHandled(s, "rock_victory_road_6"),
  ...
  },
  {
    ...
    x: 11,
    y: 13,
    conditionFunction: (s) => !occupantHandled(s, "rock_victory_road_7"),
  ...
  },
  {
    ...
    x: 16,
    y: 23,
    conditionFunction: (s) => !occupantHandled(s, "rock_victory_road_8"),
  ...
  },
  {
    ...
    x: 9,
    y: 19,
    conditionFunction: (s) => !occupantHandled(s, "rock_victory_road_9"),
  ...
  },
  {
    ...
    x: 40,
    y: 7,
    conditionFunction: (s) => !occupantHandled(s, "rock_victory_road_10"),
  ...
  },
  {
    ...
    x: 29,
    y: 3,
    conditionFunction: (s) => !occupantHandled(s, "rock_victory_road_11"),
  ...
  },
  {
    ...
    x: 14,
    y: 40,
    conditionFunction: (s) => !occupantHandled(s, "rock_victory_road_12"),
