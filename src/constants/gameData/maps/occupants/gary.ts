...
const garyTeam = () => [
  makeChallengerPokemon({
    ...
    effortValues: {
      ...EmptyStatObject,
      "special-defense": getPercentageEVfromXp(216000),
      defense: getPercentageEVfromXp(216000),
    },
  }),
  makeChallengerPokemon({
    name: "blastoise",
  ...
  makeChallengerPokemon({
    ...
    effortValues: {
      ...EmptyStatObject,
      "special-attack": getPercentageEVfromXp(216000),
      speed: getPercentageEVfromXp(216000),
    },
  }),
  makeChallengerPokemon({
    name: "tauros",
