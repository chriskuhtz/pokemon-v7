...
export const routeS1E1Occupants: OverworldMap["occupants"] = [
  ...
  },
  {
    type: "ITEM",
    id: "poke-flute",
    conditionFunction: (s) => !occupantHandled(s, "poke-flute"),
    x: 45,
    y: 3,
    item: "poke-flute",
    amount: 1,
  },
  {
    type: "ITEM",
    id: "miracle-seed",
    conditionFunction: (s) => !occupantHandled(s, "miracle-seed"),
    x: 40,
    y: 20,
    item: "miracle-seed",
    amount: 1,
  },
  {
    type: "ITEM",
    id: "twisted-spoon",
    conditionFunction: (s) => !occupantHandled(s, "twisted-spoon"),
    x: 23,
    y: 40,
    item: "twisted-spoon",
    amount: 1,
  },
  {
    type: "ITEM",
    id: "lucky-egg",
    conditionFunction: (s) => !occupantHandled(s, "lucky-egg"),
    x: 9,
    y: 23,
    item: "lucky-egg",
    amount: 1,
