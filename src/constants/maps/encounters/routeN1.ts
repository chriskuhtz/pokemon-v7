...
export const routeN1Encounters: EncounterMap = {
	...
	MORNING: [
		...
		{ name: 'ledyba', xp: 50, rarity: 'common' },
		{ name: 'ledyba', xp: 100, rarity: 'common' },
		{ name: 'ledyba', xp: 125, rarity: 'medium' },
		{ name: 'weedle', xp: 50, rarity: 'common' },
		{ name: 'weedle', xp: 100, rarity: 'common' },
		{ name: 'weedle', xp: 125, rarity: 'medium' },
		{ name: 'jigglypuff', xp: 125, rarity: 'rare' },
		{ name: 'lickitung', xp: 125, rarity: 'ultra-rare' },
	],
	DAY: [
