export const extraFeatureCheckList: {
	...
	{ name: 'growth rate slow', handled: true },
	{ name: 'growth rate medium slow' },
	{ name: 'growth rate medium' },
	{ name: 'growth rate fast' },
	{ name: 'growth rate erratic' },
	{ name: 'growth rate fluctuating' },
