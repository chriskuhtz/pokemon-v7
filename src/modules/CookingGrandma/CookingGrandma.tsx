  ...
  return (
    ...
    >
      <Stack mode="column">
        ...
        <Stack mode="row">
          {[...new Set([...BASE_RECIPES.map((e) => e.result)])].map(
            (result) => (
              <button
                key={result}
                style={{
              ...
              >
                <ItemSprite
                  grayscale={enabledRecipes.every(
          ...
          {enabledRecipes
            ...
            .map((recipe, index) => (
              <Card
                ...
                actionElements={[
                  ...recipe.ingredients.map((ing) => <ItemSprite item={ing} />),
                  <ItemInfoButton itemName={recipe.result} />,
                ]}
              />
            ))}
          {disabledRecipes
