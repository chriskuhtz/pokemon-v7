...
const changelogData: ChangelogEntryData[] = [
  ...
  },
  {
    ...
    listOfChanges: [
      "fixes and balances from playtesting",
      "dragonite taxi on routes to get back home",
    ],
  },
  {
    version: "0.76",
  ...
  {
    version: "0.57",
    listOfChanges: ["improved Recovery Tool"],
  },
  {
    version: "0.56",
