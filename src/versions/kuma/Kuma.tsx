...
export const kumaGameData: GameData = {
  ...
  features: {
    settingsEditableAtStart: {
      ...
      releaseFaintedPokemon: true,
      randomStarters: true,
      randomOverworldItems: true,
      randomQuestRewards: true,
      randomSwarms: true,
      randomAbilities: true,
      randomHeldItems: true,
      randomLearnSets: true,
      randomEncounters: true,
      randomEvolution: true,
      smarterOpponents: true,
      minimalGrindingMode: true,
      teamSelectionBeforeBattle: true,
    },
    settingsEditableDuringGame: {
      fasterDays: true,
      hideMovementButtons: true,
      unlimitedPathfindingRange: true,
      seekOutEncounters: true,
    },
    catchStreaks: true,
