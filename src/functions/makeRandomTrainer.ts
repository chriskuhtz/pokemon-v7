...
const tier3trainers: Challenger[] = [
	{
		...
		id: 'Fiery Fred 3',
		team: [
			makeChallengerPokemon({ name: 'magmar', xp: 15625 }),
			makeChallengerPokemon({ name: 'magcargo', xp: 15625 }),
			makeChallengerPokemon({ name: 'litleo', xp: 15625 }),
			makeChallengerPokemon({ name: 'heatmor', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Adrian Agua 3',
		team: [
			makeChallengerPokemon({ name: 'sealeo', xp: 15625 }),
			makeChallengerPokemon({ name: 'floatzel', xp: 15625 }),
			makeChallengerPokemon({ name: 'poliwhirl', xp: 15625 }),
			makeChallengerPokemon({ name: 'crawdaunt', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Planter Paul 3',
		team: [
			makeChallengerPokemon({ name: 'parasect', xp: 15625 }),
			makeChallengerPokemon({ name: 'gloom', xp: 15625 }),
			makeChallengerPokemon({ name: 'breloom', xp: 15625 }),
			makeChallengerPokemon({ name: 'dolliv', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Electric Erik 3',
		team: [
			makeChallengerPokemon({ name: 'electabuzz', xp: 15625 }),
			makeChallengerPokemon({ name: 'pachirisu', xp: 15625 }),
			makeChallengerPokemon({ name: 'boltund', xp: 15625 }),
			makeChallengerPokemon({ name: 'pawmo', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Haunted Hilda 3',
		team: [
			makeChallengerPokemon({ name: 'haunter', xp: 15625 }),
			makeChallengerPokemon({ name: 'trevenant', xp: 15625 }),
			makeChallengerPokemon({ name: 'dusclops', xp: 15625 }),
			makeChallengerPokemon({ name: 'banette', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Dark Dave 3',
		team: [
			makeChallengerPokemon({ name: 'houndoom', xp: 15625 }),
			makeChallengerPokemon({ name: 'murkrow', xp: 15625 }),
			makeChallengerPokemon({ name: 'nuzleaf', xp: 15625 }),
			makeChallengerPokemon({ name: 'cacturne', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Psycho Pete 3',
		team: [
			makeChallengerPokemon({ name: 'hypno', xp: 15625 }),
			makeChallengerPokemon({ name: 'kirlia', xp: 15625 }),
			makeChallengerPokemon({ name: 'espurr', xp: 15625 }),
			makeChallengerPokemon({ name: 'indeedee-male', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Fairy Frida 3',
		team: [
			makeChallengerPokemon({ name: 'clefable', xp: 15625 }),
			makeChallengerPokemon({ name: 'azumarill', xp: 15625 }),
			makeChallengerPokemon({ name: 'slurpuff', xp: 15625 }),
			makeChallengerPokemon({ name: 'alcremie', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Normal Norman 3',
		team: [
			makeChallengerPokemon({ name: 'herdier', xp: 15625 }),
			makeChallengerPokemon({ name: 'persian', xp: 15625 }),
			makeChallengerPokemon({ name: 'tauros', xp: 15625 }),
			makeChallengerPokemon({ name: 'zangoose', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Rick the Rock 3',
		team: [
			makeChallengerPokemon({ name: 'nosepass', xp: 15625 }),
			makeChallengerPokemon({ name: 'onix', xp: 15625 }),
			makeChallengerPokemon({ name: 'boldore', xp: 15625 }),
			makeChallengerPokemon({ name: 'golem', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		team: [
			makeChallengerPokemon({ name: 'sandslash', xp: 15625 }),
			makeChallengerPokemon({ name: 'sandaconda', xp: 15625 }),
			makeChallengerPokemon({ name: 'vibrava', xp: 15625 }),
			makeChallengerPokemon({ name: 'donphan', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'steely stannis 3',
		team: [
			makeChallengerPokemon({ name: 'lairon', xp: 15625 }),
			makeChallengerPokemon({ name: 'magneton', xp: 15625 }),
			makeChallengerPokemon({ name: 'skarmory', xp: 15625 }),
			makeChallengerPokemon({ name: 'mawile', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'icy irmgard 3',
		team: [
			makeChallengerPokemon({ name: 'sandslash-alola', xp: 15625 }),
			makeChallengerPokemon({ name: 'vanilluxe', xp: 15625 }),
			makeChallengerPokemon({ name: 'sealeo', xp: 15625 }),
			makeChallengerPokemon({ name: 'jynx', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		team: [
			makeChallengerPokemon({ name: 'dragonair', xp: 15625 }),
			makeChallengerPokemon({ name: 'jangmo-o', xp: 15625 }),
			makeChallengerPokemon({ name: 'shelgon', xp: 15625 }),
			makeChallengerPokemon({ name: 'druddigon', xp: 15625 }),
		],
		inventory: EmptyInventory,
		trainer: {
	...
	},
	{
		...
		id: 'fighting frank 3',
		team: [
			makeChallengerPokemon({ name: 'hitmonlee', xp: 15625 }),
			makeChallengerPokemon({ name: 'machoke', xp: 15625 }),
			makeChallengerPokemon({ name: 'gurdurr', xp: 15625 }),
			makeChallengerPokemon({ name: 'hitmonchan', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		team: [
			makeChallengerPokemon({ name: 'pidgeotto', xp: 15625 }),
			makeChallengerPokemon({ name: 'farfetchd', xp: 15625 }),
			makeChallengerPokemon({ name: 'spearow', xp: 15625 }),
			makeChallengerPokemon({ name: 'honchkrow', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		team: [
			makeChallengerPokemon({ name: 'weezing', xp: 15625 }),
			makeChallengerPokemon({ name: 'swalot', xp: 15625 }),
			makeChallengerPokemon({ name: 'toxel', xp: 15625 }),
			makeChallengerPokemon({ name: 'ariados', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Buggin Bob 3',
		team: [
			makeChallengerPokemon({ name: 'butterfree', xp: 15625 }),
			makeChallengerPokemon({ name: 'beedrill', xp: 15625 }),
			makeChallengerPokemon({ name: 'pinsir', xp: 15625 }),
			makeChallengerPokemon({ name: 'heracross', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Kanto Ken 2',
		team: [
			makeChallengerPokemon({ name: 'charmeleon', xp: 15625 }),
			makeChallengerPokemon({ name: 'wartortle', xp: 15625 }),
			makeChallengerPokemon({ name: 'ivysaur', xp: 15625 }),
			makeChallengerPokemon({ name: 'raichu', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Johto John 2',
		team: [
			makeChallengerPokemon({ name: 'quilava', xp: 15625 }),
			makeChallengerPokemon({ name: 'croconaw', xp: 15625 }),
			makeChallengerPokemon({ name: 'bayleef', xp: 15625 }),
			makeChallengerPokemon({ name: 'azumarill', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Hoenn Hannah 2',
		team: [
			makeChallengerPokemon({ name: 'combusken', xp: 15625 }),
			makeChallengerPokemon({ name: 'marshtomp', xp: 15625 }),
			makeChallengerPokemon({ name: 'grovyle', xp: 15625 }),
			makeChallengerPokemon({ name: 'plusle', xp: 15625 }),
			makeChallengerPokemon({ name: 'minun', xp: 15625 }),
		],
		inventory: EmptyInventory,
	...
	},
	{
		...
		id: 'Sinnoh Simone 2',
		team: [
			makeChallengerPokemon({ name: 'monferno', xp: 15625 }),
			makeChallengerPokemon({ name: 'prinplup', xp: 15625 }),
			makeChallengerPokemon({ name: 'grotle', xp: 15625 }),
			makeChallengerPokemon({ name: 'pachirisu', xp: 15625 }),
		],
		inventory: EmptyInventory,
